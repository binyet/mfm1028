	...
	<table id="datagrid" title="区域管理">
		<thead>
			<tr>
				...
				<th data-options="field:'propertyName',width:100,align:'left'">名称</th>
...
var grid;
	$(document).ready(function(){
			//从后台获取列表数据
			grid = datagrid('#datagrid','${ctx }/mfm/Property/getList.haze','#tb',true);
			//消息弹框
			showMessageInit();
			//按钮
			$('#buttonDiv').buttonGroup([{
				...
				click:function(){
					//打开弹窗
					$.gsWindow({
						url:'${ctx }/mfm/Property/edit.haze',
						title:'新增区域'
					});
				}
			},{
				...
				click:function(){
					getId(grid,'id',function(id){
						$.gsWindow({
							url:'${ctx }/mfm/Property/edit.haze?id='+id,
							title:'修改区域'
						});
					});	
				}
