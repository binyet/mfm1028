...
<body>
	<div id="cc">
		<f:form id="mainform" action="${ctx }/mfm/Property/save.haze" method="post">
			...
			<div data-options="region:'center',border:false" style="padding-top: 5px;">
				...
				<f:form-item labelName="性质名称" labelSm="2" eleSm="3">
					<input type="text" class="form-control" placeholder="性质名称" validate="{notEmpty:{}}" id="propertyName" name="propertyName" value="${property.propertyName }">
				</f:form-item>
				
				<f:form-item labelName="描述" labelSm="2" eleSm="3">
					<input type="text" class="form-control" placeholder="描述"  id="remark" name="remark" value="${property.remark }">
				</f:form-item>
			</div>
