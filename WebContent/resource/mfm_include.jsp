...
<link rel="shortcut icon" href="${ctx }/resource/resource/frame/image/icon.ico" type="image/x-icon" />
...
<script type="text/javascript" src="${ctx }/resource/easyui/js/gs.ui.datagrid.scrollview.js"></script>
<!--echarts  -->
<script type="text/javascript" src="${ctx }/resource/resource/echarts/echarts.min.js"></script>

<script type="text/javascript" src="${ctx }/gresource/mfm/mater/stock/mis.js"></script>